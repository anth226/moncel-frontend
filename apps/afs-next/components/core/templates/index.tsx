...
export const CollapsibleTableCell = (props: CollapsibleTableCellProps) => {
  ...
  return <Accordion square classes={{ root: `!shadow-none !border-teal !border-t !border-l !border-r ${props.last ? '!border-b' : ''}` }} disableGutters {...props.accordionProps} expanded={props.expanded}>
    <AccordionSummary className="!bg-haze w-full text-sm font-medium !px-3 !py-2 !border-b !border-teal !border-solid -mb-[1px]" classes={{ root: '!py-0 !px-3 min-h-0 !border-b !border-teal', content: ''}} expandIcon={<ExpandIcon/>} onClick={props.onClick}>
      { props.summary }
    </AccordionSummary>
