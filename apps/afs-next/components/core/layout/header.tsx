    ...
    return <div className="flex flex-col w-full" id="section-header-mobile">
        ...
        <div className="lg:hidden bg-teal w-full py-2">
            <div className="padded-section flex">
                <NextLink href="/"><Image src={`/afs-logo-full-width-white.svg`} alt="Australian Institute of Food Safety Logo" priority width={252} height={33} className="m-0 p-0" /></NextLink>
            </div>
        </div>
    ...
    return <div className="hidden lg:flex flex-col w-full items-apart" id="section-header-desktop">
        ...
        <div className="padded-section w-full flex flex-row justify-between p-0">
            ...
            <div className="flex flex-row flex-auto">
                <NextLink href="/"><Image src="/afs-logo-full-width-green.svg" alt="Australian Institute of Food Safety Logo" priority width={375} height={48} className="hover:cursor-pointer"/></NextLink>
            </div>
