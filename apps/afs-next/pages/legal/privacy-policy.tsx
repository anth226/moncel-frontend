...
const Page = () => {
  return (
    <Layout pageTitle='Privacy Policy | AIFS' metaDescription="AIFS is committed to protecting the privacy of it's customers. This policy explains how we deal with any personal information that's received.">
