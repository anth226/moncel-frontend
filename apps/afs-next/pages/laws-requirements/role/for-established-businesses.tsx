...
const Section1 = () => {
  return <div className="col-span-3">
    <Header3 className="text-afs-green font-semibold pb-6">Comply with all laws. All the time.</Header3>
    <div className={`${styles["laws-requirements"]} col-span-3`}>
      <div className="flex flex-col pr-4">
        <Text className="pb-5">If you manage an established food business,{`you've`} probably got a food safety plan in place and have your most senior staff trained in food safety.</Text>
        <Text className="pb-5">But as things change you need to be sure {`you're`} always meeting your state and federal compliance requirements. For example:</Text>
        <ul>
        ...
        <Text className="pb-5">{`It's`} not just the law you need to think about.</Text>
        <Text className="pb-5">Your customers may be suffering as unsafe food practices creep in to everyday business activities.</Text>
      </div>
      <Image src="/laws-requirements/role/photo_establishedbusiness.jpg" alt="laws-requirements-for-employees-graphic" layout="fixed" width={325} height={183}/>
    </div>
  </div>;
};
...
const Section2 = () => {
  return <div className="col-span-3">
    <Header3 className="text-afs-green font-semibold pb-6">Know your Food Safety Laws</Header3>
      ...
      <div className="flex flex-col pr-4">
        <div className="grid grid-cols-2 grid-flow-row gap-7">
            ...
            <IconCard
                ...
                >
                <Text className="pb-3.5">Each state has {`it's`} own Food Safety Act that needs to be adhered to.</Text>
