...
const Page = () => {
  return (
    <Layout pageTitle={`Food Safety Laws & Requirements for Employees | AIFS`} metaDescription='Ensure your food safety training is up-to-date and nationally recognised - while protecting your customers.'>
