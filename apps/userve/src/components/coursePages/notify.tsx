...
const NotifyFormSection = (props:NotifyProps) => {
    return <div>
            ...
            <div className="modal-dialog modal-dialog-centered relative w-auto pointer-events-none">
                <div className="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                    <div className="modal-body relative p-8">
                        ...
                        <HubspotContactForm portalId="21498581" formId="769b522c-30a7-42dc-9da5-11ea2d6b0a06" hubId="not" className="text-inherit !drop-shadow-none !p-0" state={props.state}/>
                    </div>
                </div>
            </div>
        </div>
