...
import { StoryBlokCertificateHeroContent, StoryBlokCertificateBenefitContent, StoryBlokCertificateRecommendationContent, StoryBlokCertificateStatisticsContent, StoryBlokCertificateStory, StoryBlokHeader, StoryBlokFooter, StoryBlokCertificateFaqsContent } from 'moncel-one-sdk/cdn/types';
...
const Certificate = (props: InferGetStaticPropsType<typeof getStaticProps>) => {
    ...
    const faqs: StoryBlokCertificateFaqsContent = jsonata('body[component="section_faqs_secondary"]').evaluate(props.certificate?.content);
